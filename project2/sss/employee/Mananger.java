...
public class Mananger extends Employee { 
    ...
    public Mananger(String iD, String password, String login, String name, String surname,Date birthDate, String email, Language language, Gender gender, int salary,Manangers manangers) {
